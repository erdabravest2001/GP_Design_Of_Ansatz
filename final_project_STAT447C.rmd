---
title: "Estimation of Ro-Vibrational Eigenphases Using Gaussian Processes and Bayesian Quantum Phase Estimation"
...
The quantum circuit is parameterized by $k \in \mathbb{N}$ and $\beta \in [0,1]$. The circuit is then used to
